...
public class HeartRateDDA : MonoBehaviour
{
    ...
    public float DeadZoneFactor = 0.04f; // Example value, adjust as needed
    public float ScopePercentage = 0.1f; // Example value, adjust as needed
    ...
    void Update()
    {
        if (heartRateService.baselineCalculated)
        {
    ...
    void CalculateDifficulty()
    {
        ...
        float HeartRateMedian = heartRateService.baselineHeartRate;
        ...
        ScopePercentage += 0.05f * PercentageOutside / 60;
